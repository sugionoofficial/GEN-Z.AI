...
(function () {
    ...
    function closeModal() {
        ...
        if (
            ...
            try {
                ...
                console.warn(
                    "[model-form-events] Form close error:",
                    error
                );
            }
        }
    ...
    async function handleSubmit(
        ...
        if (
            form &&
            typeof form.saveModel ===
                "function"
        ) {
            return await form.saveModel(
                event
            );
        }

        /*
         * Fallback Create module.
         */
        const create =
            getCreateModule();
